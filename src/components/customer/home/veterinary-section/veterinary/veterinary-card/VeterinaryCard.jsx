...
const VeterinaryCard = () => {
  return (
    <div className="group hover:scale-105 cursor-pointer duration-300 ease-in-out">
      <div className="bg-[rgba(0,0,0,0.1)] h-[200px] rounded-[16px] relative overflow-hidden">
        <img
          src={IMAGES.clinicSample}
          alt=""
          className="object-cover min-w-full min-h-full translate-y-[-50%] relative top-[50%]"
        />
        ...
        <div className="absolute bg-white px-2.5 py-0.5 rounded-[.375rem] top-[10px] right-[10px] flex justify-center items-center gap-1.5">
          ...
          <span className="text-[13px] text-[rgba(0,0,0,0.5)] text-center translate-y-[1px]">
            4.9
          </span>
        </div>
      </div>
      <div className="mt-2.5 flex justify-between">
        <div className="py-2">
          <h3 className="font-medium text-[rgba(0,0,0,0.7)] group-hover:text-[rgba(0,0,0,0.8)] ">Amalfi Coast</h3>
        ...
        <div className="flex items-center pr-2.5">
          <div className="flex gap-1 items-center">
            <p className="text-[14px] cursor-pointer text-[rgba(0,0,0,0.7)] hover:text-[rgba(0,0,0,1)]">
              View
            </p>
