...
const Content = () => {
  ...
  return (
    <div
      className={`w-[100%] h-[100%] top-[2vh] left-0 `}
    >
      <div className="h-[100%] flex flex-col justify-center items-center">
        <h1
          className={`font-family-playfair-display text-[40px] w-[45vw] text-center mb-5 text-(--color-title-100) `}
        >
          FBase connects you to trusted pet care services and reputable clinics.
        </h1>
        <p
          className={`w-[30vw] text-[14px] text-center text-[rgba(0,0,0,0.5)] `}
        >
        ...
        <div className={`mx-auto container mt-20  flex justify-center gap-10 `}>
          <Clinics />
          <Clinics />
          <Clinics />
          <Clinics />
