        ...
        <div className=" mt-10 flex flex-col gap-8">
          <div className="flex flex-col">
            <label className="text-[14px] mb-0.5 text-(--color-title-60)">
              Clinic/Hospital Name <span className="text-(--color-primary-100)">*</span>
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col">
            <label className="text-[14px] mb-0.5 text-(--color-title-60)">
              Public Contact Phone Number <span className="text-(--color-primary-100)">*</span>
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col">
            <label className="text-[14px] mb-0.5 text-(--color-title-60)">
              Detailed Address <span className="text-(--color-primary-100)">*</span>
            </label>
            <input
              type="text"
          ...
          <div className="mt-10 mb-[40px]">
              <ElevatedButton width="200px" height="50px" text="Continue" handleOnclick={() => setCurrentStep(prev => prev+1)}/>
          </div>
        </div>
      </div>
    </div>
